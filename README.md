...
- 📦 Design and Configure entire Ecosystem for train, deploy LLM in AWS using best practises

- 📦 Setup vector database (Qdrant) in hybrid mode 
...
- 🎖 Introduction to GitOps (LFS169) & GitOps Fundamentals ( ArgoCD )
